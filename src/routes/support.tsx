...
const faqs = [
  {
    ...
    a: "Standard shipping takes 5–10 business days worldwide. Express shipping (3–5 days) is available at checkout.",
  },
  {
    q: "Is my order authentic?",
    a: "Yes — we source every product directly from authorized Korean distributors. Authenticity is guaranteed or your money back.",
  },
  {
    q: "What is your return policy?",
    a: "Unopened items can be returned within 30 days for a full refund. Opened skincare cannot be returned for hygiene reasons.",
  },
  {
    q: "Do you ship internationally?",
    a: "We ship to over 80 countries. Free worldwide shipping on orders over $80.",
  },
  {
    q: "How do I apply a promo code?",
    a: "Enter your code in the promo code field at checkout and click Apply. Discounts will appear in your order summary.",
  },
  {
    q: "Are your products cruelty-free?",
    a: "All GLOW products are 100% cruelty-free. We never test on animals and only partner with brands that share our values.",
  },
  {
    q: "Can I modify or cancel my order?",
    a: "Orders can be modified or cancelled within 1 hour of placement. Contact our support team immediately.",
  },
];
