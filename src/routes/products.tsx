...
export const Route = createFileRoute("/products")({
  head: () => ({ meta: [{ title: "All Products — GLOW" }, { name: "description", content: "Browse our full edit of luxury Korean cosmetics." }] }),
...
type Product = {
  ...
  rating: number | null; is_new: boolean | null; category_id: string | null;
};
...
function ProductsPage() {
  ...
  const filtered = useMemo(() => {
    ...
    if (sort === "price-low") list = [...list].sort((a, b) => (a.sale_price ?? a.price) - (b.sale_price ?? b.price));
    else if (sort === "price-high") list = [...list].sort((a, b) => (b.sale_price ?? b.price) - (a.sale_price ?? a.price));
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid lg:grid-cols-[260px_1fr] gap-8">
        <aside className="space-y-6 luxe-card rounded-xl p-6 h-fit">
          ...
          <div>
            <label className="text-xs uppercase tracking-wider text-muted-foreground mb-2 block">Sort</label>
